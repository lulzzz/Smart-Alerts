...
namespace Microsoft.Azure.Monitoring.SmartDetectors.Package
{
    ...
    public class InvalidSmartDetectorPackageException : Exception
    {
        ...
        public InvalidSmartDetectorPackageException(string message) : base(message)
        {
        }
        ...
        public InvalidSmartDetectorPackageException(string message, Exception e) : base(message, e)
        {
        }
