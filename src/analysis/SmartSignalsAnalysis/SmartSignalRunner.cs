...
namespace Microsoft.Azure.Monitoring.SmartSignals.Analysis
{
    ...
    public class SmartSignalRunner : ISmartSignalRunner
    {
        ...
        public async Task<List<AlertPresentation>> RunAsync(SmartDetectorRequest request, CancellationToken cancellationToken)
        {
            ...
            // Create results
            List<AlertPresentation> results = new List<AlertPresentation>();
            foreach (var alert in alerts)
            {
                ...
                results.Add(AlertPresentation.CreateFromAlert(request, smartDetectorManifest.Name, alert, queryRunInfo));
            }
