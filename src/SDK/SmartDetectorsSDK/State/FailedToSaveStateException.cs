...
namespace Microsoft.Azure.Monitoring.SmartDetectors.State
{
    ...
    public class FailedToSaveStateException : StateException
    {
        ...
        public FailedToSaveStateException(Exception innerException)
            : base("Unable to save state. See inner exception for more details.", innerException)
        {
        }
        ...
        protected FailedToSaveStateException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
    }
}
