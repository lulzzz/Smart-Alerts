    ...
    public static class SmartSignalRunnerMain
    {
        ...
        public static int Main(string[] args)
        {
            ...
            try
            {
                ...
                childProcessManager.RunAndListenToParentAsync<SmartDetectorExecutionRequest, List<ContractsAlert>>(args, RunSignalAsync).Wait();
        ...
        private static async Task<List<ContractsAlert>> RunSignalAsync(SmartDetectorExecutionRequest request, CancellationToken cancellationToken)
        {
