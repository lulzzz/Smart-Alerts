...
namespace Microsoft.Azure.Monitoring.SmartDetectors.Package
{
    ...
    public sealed class SmartDetectorManifest
    {
        ...
        public SmartDetectorManifest(string id, string name, string description, Version version, string assemblyName, string className, IReadOnlyList<ResourceType> supportedResourceTypes, IReadOnlyList<int> supportedCadencesInMinutes)
        {
