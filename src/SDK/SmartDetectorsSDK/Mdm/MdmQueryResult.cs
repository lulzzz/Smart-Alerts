...
namespace Microsoft.Azure.Monitoring.SmartDetectors.Mdm
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MdmQueryResult"/> class 
        /// </summary>
        ...
        public MdmQueryResult(string name, string unit, IReadOnlyList<MetricTimeSeries> timeseries)
        {
            this.Name = name;
            this.Unit = unit;
