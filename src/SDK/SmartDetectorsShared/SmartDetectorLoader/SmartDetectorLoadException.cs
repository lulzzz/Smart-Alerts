...
namespace Microsoft.Azure.Monitoring.SmartDetectors.SmartDetectorLoader
{
    ...
    public class SmartDetectorLoadException : Exception
    {
        ...
        public SmartDetectorLoadException(string message) : base(message)
        {
        }
        ...
        public SmartDetectorLoadException(string message, Exception innerException) : base(message, innerException)
        {
        }
