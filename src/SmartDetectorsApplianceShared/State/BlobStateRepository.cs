...
namespace Microsoft.Azure.Monitoring.MonitoringAppliance.State
{
    ...
    public class BlobStateRepository : IStateRepository
    {
        ...
        public Task StoreStateAsync<T>(string key, T state, CancellationToken cancellationToken)
        {
            ...
            this.tracer.TraceInformation($"Serializing state for {smartDetectorId}");
            ...
            this.tracer.TraceInformation($"Compressing state for {smartDetectorId}");
            ...
            this.tracer.TraceInformation($"Uploading state to '{this.GenerateBlobName(key)}' for {smartDetectorId}");
            ...
            this.tracer.TraceInformation($"Successfully uploaded state for {smartDetectorId}");
        ...
        private string GenerateBlobName(string key)
        {
            ...
            string blobName = $"{safeSmartDetectorId}_{smartDetectorIdHash}/{keyHash}";
