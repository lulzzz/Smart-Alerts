    ...
    public static class SmartSignalRunnerMain
    {
        ...
        public static int Main(string[] args)
        {
            ...
            try
            {
                ...
                childProcessManager.RunAndListenToParentAsync<SmartDetectorRequest, List<AlertPresentation>>(args, RunSignalAsync).Wait();
        ...
        private static async Task<List<AlertPresentation>> RunSignalAsync(SmartDetectorRequest request, CancellationToken cancellationToken)
        {
